...
from src.interpretability import analyze_feature_importance_with_progress
...
def main():
    ...
    X_train_norm, X_test_norm = normalize_specific_columns(X_train.copy(), X_test.copy(), columns_to_normalize)
